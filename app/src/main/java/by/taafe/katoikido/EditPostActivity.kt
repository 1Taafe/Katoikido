...
class EditPostActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val storageReference = Firebase.storage.reference.child(Post.tempContainer.imageUrl)
        titleInput.editText?.setText(Post.tempContainer.title)
        postTextInput.editText?.setText(Post.tempContainer.text)
        postTypeText.setText(Post.tempContainer.type)
        petTypeText.setText(Post.tempContainer.petType)
        ...
        storageReference.downloadUrl.addOnSuccessListener {
            Glide.with(this)
                .load(it)
                .apply(RequestOptions.circleCropTransform())
                .placeholder(Loader.create(this, 100f, 10f))
                .transition(DrawableTransitionOptions.withCrossFade())
    ...
    fun AddPost(view: View) {
        ...
        if(post.type.isEmpty() || post.petType.isEmpty()
            ...
            if(postImagePath != Post.undefined){

                postImageRef.delete().addOnSuccessListener {
                    ...
                    uploadTask.addOnFailureListener {
                        ...
                        post.imageUrl = Post.undefined
                        myRef.setValue(post)

                        post.imageUrl = Post.tempContainer.imageUrl
                        myRef.setValue(post)
                    ...
                    Toast.makeText(this, "Не удалось удалить предыдущее изображение!", Toast.LENGTH_LONG).show()
                }
